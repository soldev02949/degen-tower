...
export default function TapGame() {
  const {user,signOut}=useAuth();
  const [activeTab,setActiveTab]=useState<"home"|"play"|"multi"|"shop"|"profile"|"quests"|"achievements"|"ranks"|"settings">("home");
